...
while True:
    ...
    want_to_continue = input("If you want to continue our calculations - print yes, if you want to end - print no: ")
    if 'yes' in want_to_continue.lower():
        print("Great! Let`s calculate more!")
        continue
    elif 'no' in want_to_continue.lower():
        print("Bye-bye! Hope you had fun")
        break
    else:
        print("I don`t understand you, my friend, that`s why I say bye-bye!")
